...
{
    public partial class Ticari_hesap_oluştur : Form
    {
        public Ticari_hesap_oluştur()
        {
            InitializeComponent();
        }
        ...
        private void btnOluştur_Click(object sender, EventArgs e)
        {
            ...
            baglantı.Open();
            NpgsqlCommand komut = new NpgsqlCommand("insert into ticarimusteri (ad,soyad,şifre,telefon,hesapno,bakiye) values (@p1,@p2,@p3,@p4,@p5,@p6)", baglantı);
